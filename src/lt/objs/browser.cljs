...
(object/tag-behaviors :frame.client [::cljs-exec ::handle-send! ::handle-refresh! ::html-eval ::css-eval ::js-eval ::js-eval-file ::handle-close! ::change-live])
(object/tag-behaviors :browser [::store-history ::destroy-on-close ::set-active ::rem-client ::set-client-name ::init! ::navigate! ::back! ::forward! ::refresh! ::focus!])
