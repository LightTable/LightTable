    ...
    socket.on('editor.eval.cljs.exec', function (message) {
      ...
      for(var i = 0; i < prev.data.results.length; i++) {
        ...
        try {
          ...
          socket.emit("result", toMessage(prev, "editor.eval.cljs.exception", {ex: e.stack || cljs.core.pr_str(cljs.core.type(e)) + ": " + cljs.core.pr_str(cljs.core.ex_data(e)), meta: prev.data.results[i].meta}));
        }
      }
    });
