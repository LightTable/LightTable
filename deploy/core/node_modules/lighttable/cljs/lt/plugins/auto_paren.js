...
return lt.objs.editor.replace_selection.call(null,this$,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(ch),cljs.core.str.cljs$core$IFn$_invoke$arity$1(current_selection),cljs.core.str.cljs$core$IFn$_invoke$arity$1(lt.plugins.auto_paren.pairs.call(null,ch))].join(''),new cljs.core.Keyword(null,"around","around",-265975553));
} else {
...
lt.objs.editor.insert_at_cursor.call(null,this$,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(ch),cljs.core.str.cljs$core$IFn$_invoke$arity$1(lt.plugins.auto_paren.pairs.call(null,ch))].join(''));
...
var current_selection = lt.objs.editor.selection.call(null,this$);
if((!(cljs.core._EQ_.call(null,current_selection,"")))){
return lt.objs.editor.replace_selection.call(null,this$,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(ch),cljs.core.str.cljs$core$IFn$_invoke$arity$1(current_selection),cljs.core.str.cljs$core$IFn$_invoke$arity$1(ch)].join(''));
} else {
if(cljs.core._EQ_.call(null,ch,lt.plugins.auto_paren.get_char.call(null,this$,(1)))){
return lt.plugins.auto_paren.move_cursor.call(null,this$,(1));
} else {
...
lt.objs.editor.insert_at_cursor.call(null,this$,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(ch),cljs.core.str.cljs$core$IFn$_invoke$arity$1(ch)].join(''));
...
if(cljs.core.truth_((function (){var and__4149__auto__ = lt.plugins.auto_paren.pairs.call(null,ch);
...
lt.plugins.auto_paren.pre_cursor_indent = (function lt$plugins$auto_paren$pre_cursor_indent(ed,p__10443){
var map__10444 = p__10443;
var map__10444__$1 = cljs.core.__destructure_map.call(null,map__10444);
var line = cljs.core.get.call(null,map__10444__$1,new cljs.core.Keyword(null,"line","line",212345235));
var ch = cljs.core.get.call(null,map__10444__$1,new cljs.core.Keyword(null,"ch","ch",-554717905));
...
if(cljs.core.not.call(null,(function (){var or__4160__auto__ = lt.objs.editor.selection_QMARK_.call(null,ed);
...
var unit = lt.objs.editor.option.call(null,ed,new cljs.core.Keyword(null,"indentUnit","indentUnit",438562839));
var vec__10445 = lt.plugins.auto_paren.pre_cursor_indent.call(null,ed,cursor);
var indent = cljs.core.nth.call(null,vec__10445,(0),null);
var rem = cljs.core.nth.call(null,vec__10445,(1),null);
var cursor__$1 = (((rem > (0)))?lt.plugins.auto_paren.adjust_loc.call(null,lt.objs.editor.__GT_cursor.call(null,ed),(unit - rem)):cursor);
var vec__10448 = (((rem > (0)))?lt.plugins.auto_paren.pre_cursor_indent.call(null,ed,cursor__$1):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [indent,rem], null));
var indent__$1 = cljs.core.nth.call(null,vec__10448,(0),null);
var rem__$1 = cljs.core.nth.call(null,vec__10448,(1),null);
