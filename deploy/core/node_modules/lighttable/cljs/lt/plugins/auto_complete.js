...
if(cljs.core.truth_((function (){var and__4149__auto__ = lt.plugins.auto_complete.peek_STAR_.call(null,s);
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__9733_SHARP_){
return ({"completion": p1__9733_SHARP_});
}),Object.keys(res)));
});
...
var or__4160__auto__ = new cljs.core.Keyword(null,"hint-pattern","hint-pattern",-1622710880).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,ed));
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
var or__4160__auto____$1 = (mode["hint-pattern"]);
...
var pred__9737 = cljs.core._EQ_;
var expr__9738 = ch.origin;
if(cljs.core.truth_(pred__9737.call(null,"+input",expr__9738))){
return cljs.core.some.call(null,(function (p1__9736_SHARP_){
return cljs.core.not.call(null,cljs.core.re_seq.call(null,pattern,p1__9736_SHARP_));
}),text);
} else {
if(cljs.core.truth_(pred__9737.call(null,"paste",expr__9738))){
return true;
} else {
return false;
}
...
lt.plugins.auto_complete.w = lt.objs.thread.thread_STAR_.call(null,(function lt$plugins$auto_complete$tfun9741(){
...
var StringStream = require([cljs.core.str.cljs$core$IFn$_invoke$arity$1(ltpath),"/core/node_modules/codemirror/addon/runmode/runmode.node.js"].join('')).StringStream;
var stream = (function (s){
return (new StringStream(s));
});
var advance = (function (s){
return (s.start = s.pos);
});
var next_STAR_ = (function (s){
return s.next();
});
var peek_STAR_ = (function (s){
return s.peek();
});
var current = (function (s){
return s.current();
});
var skip_space = (function (s){
if(cljs.core.truth_((function (){var and__4149__auto__ = peek_STAR_.call(null,s);
if(cljs.core.truth_(and__4149__auto__)){
...
var eat_while = (function (s,r){
return s.eatWhile(r);
});
var string__GT_tokens = (function (str,pattern){
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__9740_SHARP_){
return ({"completion": p1__9740_SHARP_});
}),Object.keys(res)));
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(x.text),cljs.core.str.cljs$core$IFn$_invoke$arity$1(x.completion)].join('');
});
lt.plugins.auto_complete.distinct_completions = (function lt$plugins$auto_complete$distinct_completions(hints){
var seen = ({});
return cljs.core.filter.call(null,(function (hint){
...
return cljs.core.filter.call(null,(function (p1__9744_SHARP_){
return (p1__9744_SHARP_.completion.length < new cljs.core.Keyword(null,"hint-limit","hint-limit",55979791).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.plugins.auto_complete.hinter)));
}),hints);
});
...
return lt.plugins.auto_complete.distinct_completions.call(null,lt.plugins.auto_complete.remove_long_completions.call(null,(cljs.core.truth_(token)?cljs.core.remove.call(null,(function (p1__9745_SHARP_){
return cljs.core._EQ_.call(null,token,p1__9745_SHARP_.completion);
...
if(cljs.core.truth_((function (){var or__4160__auto__ = lt.plugins.auto_complete.non_token_change_QMARK_.call(null,new cljs.core.Keyword(null,"ed","ed",436294224).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,this$)),c);
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
...
if(cljs.core.truth_(((cljs.core._EQ_.call(null,(1),count))?new cljs.core.Keyword(null,"select-single","select-single",516810952).cljs$core$IFn$_invoke$arity$1(opts):false))){
...
if(cljs.core.truth_((function (){var and__4149__auto__ = new cljs.core.Keyword(null,"active","active",1895962068).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.plugins.auto_complete.hinter));
if(cljs.core.truth_(and__4149__auto__)){
...
if(cljs.core.truth_((function (){var and__4149__auto__ = starting;
if(cljs.core.truth_(and__4149__auto__)){
var and__4149__auto____$1 = cur;
