...
return console.log(["No such client: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sock)].join(''));
}
});
...
var temp__5753__auto__ = lt.objs.clients.by_name.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(data__$2));
...
socket.on("result",(function (p1__11783_SHARP_){
return lt.objs.clients.ws.on_result.call(null,socket,p1__11783_SHARP_);
}));
...
ws.server.on("error",(function (p1__11784_SHARP_){
if(cljs.core._EQ_.call(null,p1__11784_SHARP_.code,"EADDRINUSE")){
console.log("Default socket.io port already used. Retrying with a random port.");

return ws.server.listen((0));
} else {
throw p1__11784_SHARP_;
}
}));

ws.server.on("listening",(function (){
