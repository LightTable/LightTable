...
return sock.write([cljs.core.str.cljs$core$IFn$_invoke$arity$1(JSON.stringify(msg)),"\n"].join(''));
} else {
return cljs.core.println.call(null,["No such client: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sock)].join(''));
}
});
...
var temp__5753__auto__ = lt.objs.clients.by_name.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(data__$1));
...
var buf = buffer;
while(true){
if(cljs.core.truth_((function (){var and__4149__auto__ = loc__$1;
...
(socket.ltbuffer = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__4160__auto__ = socket.ltbuffer;
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
return "";
}
})()),cljs.core.str.cljs$core$IFn$_invoke$arity$1(data)].join(''));
...
return socket.on("data",(function (p1__11779_SHARP_){
return lt.objs.clients.tcp.on_result.call(null,socket,p1__11779_SHARP_);
}));
});
