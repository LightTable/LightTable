...
var pred__6465 = cljs.core._EQ_;
var expr__6466 = plat;
if(cljs.core.truth_(pred__6465.call(null,"win32",expr__6466))){
return new cljs.core.Keyword(null,"windows","windows",2068861701);
} else {
if(cljs.core.truth_(pred__6465.call(null,"linux",expr__6466))){
return new cljs.core.Keyword(null,"linux","linux",-238042662);
} else {
if(cljs.core.truth_(pred__6465.call(null,"darwin",expr__6466))){
return new cljs.core.Keyword(null,"mac","mac",-1879391650);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__6466)].join('')));
}
}
}
});
