...
lt.objs.sidebar.navigate.populate_bg = lt.objs.thread.thread_STAR_.call(null,(function lt$objs$sidebar$navigate$tfun14133(){
...
return (function (obj_id,p__14134){
var map__14135 = p__14134;
var map__14135__$1 = cljs.core.__destructure_map.call(null,map__14135);
var lim = cljs.core.get.call(null,map__14135__$1,new cljs.core.Keyword(null,"lim","lim",1172958742));
var pattern = cljs.core.get.call(null,map__14135__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var ws = cljs.core.get.call(null,map__14135__$1,new cljs.core.Keyword(null,"ws","ws",86841443));
var fs = require("fs");
var fpath = require("path");
var walkdir = require([cljs.core.str.cljs$core$IFn$_invoke$arity$1(ltpath),"/core/node_modules/lighttable/background/walkdir2.js"].join(''));
var grab_files = (function (all_files,folder){
var root_length = (cljs.core.count.call(null,fpath.dirname(folder)) + (1));
var walked = walkdir.call(null,folder,(function (){var obj14137 = ({"filter":(new RegExp(pattern)),"limit":lim});
return obj14137;
})());
return all_files.concat(walked.paths.map((function (p1__14131_SHARP_){
var obj14139 = ({"full":p1__14131_SHARP_,"rel":cljs.core.subs.call(null,p1__14131_SHARP_,root_length)});
return obj14139;
})));
});
...
var other_files = cljs.core.to_array.call(null,new cljs.core.Keyword(null,"files","files",-472457450).cljs$core$IFn$_invoke$arity$1(ws)).map((function (p1__14132_SHARP_){
var obj14141 = ({"full":p1__14132_SHARP_,"rel":fpath.basename(p1__14132_SHARP_)});
return obj14141;
}));
...
var ws_parent = lt.objs.files.parent.call(null,cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__14142_SHARP_){
return cljs.core._EQ_.call(null,(0),path.indexOf(p1__14142_SHARP_));
...
lt.object.update_BANG_.call(null,lt.objs.sidebar.navigate.sidebar_navigate,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"files","files",-472457450)], null),(function (p1__14143_SHARP_){
...
var list = lt.objs.sidebar.command.filter_list.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"rel","rel",1378823488),new cljs.core.Keyword(null,"transform","transform",1381301764),(function (p1__14144_SHARP_,p2__14146_SHARP_,p3__14145_SHARP_){
return ["<h2>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(lt.objs.files.basename.call(null,p1__14144_SHARP_)),"</h2><p>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p3__14145_SHARP_),"</p>"].join('');
}),new cljs.core.Keyword(null,"items","items",1031954938),singultus.binding.subatom.call(null,this$,new cljs.core.Keyword(null,"files","files",-472457450)),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"file"], null));
