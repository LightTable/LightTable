...
(function(window, document, undefined) {
    ...
    function _handleKeyEvent(e) {
        ...
        if (e.type == 'keydown' && (keyDownOnly(e) || e.ctrlKey || e.metaKey)) {
    ...
    // start!
    _addEvent(document, 'keypress', _handleKeyEvent, true);
    _addEvent(document, 'keydown', _handleKeyEvent, true);
    _addEvent(document, 'keyup', _handleKeyEvent, true);
